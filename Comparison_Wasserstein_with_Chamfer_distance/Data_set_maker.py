...
"""
class Data_set_maker_add_noise_and_rigid_transformation():
    ...
    def __call__(self):
        ...
        source_dataset_added_noise_rigid_transformed = self.Dataset_Transformation(len(source_dataset_added_noise), angle_range = self.angle_range, translation_range= self.translation_range)(source_dataset_added_noise)
